...
import { Beam } from '@/types/beam.ts';
...
export function BeamCanvas({ beam, error, className, ...props }: BeamCanvasProps) {
    ...
    return (
        <div className={cn("w-full h-full bg-white relative overflow-hidden", className)} {...props}>
