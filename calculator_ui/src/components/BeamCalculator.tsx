...
import BendingMomentDiagram from "@/components/render/beam/diagram/BendingMomentDiagram";
import ShearForceDiagram from "@/components/render/beam/diagram/ShearForceDiagram";
