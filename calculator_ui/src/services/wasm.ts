import {ICalculatorService, PrincipalMomentsOutput} from "@/services/interface.ts";

interface WASMCalculator {
    principal_moments_and_transform(equation: string, ny: number, nz: number): Promise<PrincipalMomentsOutput>;
}
